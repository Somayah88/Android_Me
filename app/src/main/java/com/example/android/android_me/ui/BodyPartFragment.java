...
public class BodyPartFragment extends Fragment {
    ...
    private static final String IMAGE_ID="image_ids";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        {
            mImageIds=savedInstanceState.getIntegerArrayList(IMAGE_ID);
    ...
    @Override
    public void onSaveInstanceState(Bundle currentBundle)
    {
        currentBundle.putIntegerArrayList(IMAGE_ID,(ArrayList<Integer>)mImageIds);
        currentBundle.putInt(LIST_INDEX,mListIndex);
